<?php 
    $infouser=json_decode($data["Infouser"], true); 
?>
<!DOCTYPE html>
<html lang="en">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <!-- style="background-image: linear-gradient(180deg, #E06F18 10%, #e03618 100%);" -->
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item" href="./Admin/Generalcalendar">Điểm Danh</a>
                                <a class="collapse-item" href="./Admin/Event">Sự Kiện</a>  
                                <a class="collapse-item" href="./Admin/User">Tài Khoản</a>                                               
                            </div>
                        </div>
                    </li>
                    ';
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="./Admin/Profile">Thông Tin Cá Nhân</a>
                        <a class="collapse-item" href="./Admin/Changepass">Đổi Mật Khẩu</a>
                    </div>
                </div>
            </li>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <input onchange="Search()" id="myInput" type="text" class="form-control bg-light border-0 small" placeholder="Tìm kiếm..."
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?=$infouser["username"]?></span>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="./Ajax/Logout">Đăng xuất</a>
                </div>
            </div>
        </div>
    </div>
